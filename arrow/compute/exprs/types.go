...
func init() {
	...
	for _, fn := range []string{"equal", "not_equal", "lt", "lte", "gt", "gte", "and_kleene", "or_kleene"} {
		err := DefaultExtensionIDRegistry.AddSubstraitScalarToArrow(
	...
	for _, fn := range []string{"equal", "not_equal", "less", "less_equal", "greater", "greater_equal", "and", "or"} {
		err := DefaultExtensionIDRegistry.AddArrowToSubstrait(fn,
